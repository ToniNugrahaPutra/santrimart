              ...
              <div class="col-lg-6 col-6">
                <fieldset>
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="kodebarang" name="kodebarang" autofocus="autofocus"
                      placeholder="Scan Here!" aria-describedby="button-addon2" onkeyup="check_data()">
                    <div class="input-group-append" id="button-addon2">
                      <button class="btn btn-primary rounded-0" type="button" onclick="startBarcodeScanner()"><i
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="barang" id="barang" onchange="add_data()">
                    ...
                    while ($a = mysqli_fetch_array($executeSat)) {
                      ?>
                      <option value="<?php echo $a['kd_barang']; ?>">
                        <?php echo $a['nm_barang']; ?>&nbsp;&nbsp;(<?php echo $a['stok']; ?>)
                      </option>
                    <?php } ?>
                  </select>
                </div>
      ...
      success: function (data) {
        ...
        var text = `<tr id="kode${response.kd_barang}">                                    
                        ...
                        <td>
                          <div class="d-inline-block mb-1">
                            <div class="input-group">
                              <input type="text" value="${response.hrg_jual}" onkeyup="cek_jumlah()" disabled>
                            </div>
                          </div>
                        </td>
                        <td>
