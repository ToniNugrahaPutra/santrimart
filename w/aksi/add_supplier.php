...
if ($nama != '' && $telepon != '' && $email != '' && $alamat != '' && $keterangan != '') {
    ...
    if ($jml_supplier > 0) {
        ...
        $query = "INSERT INTO tabel_supplier (kd_supplier,tgl_masuk,nama,alamat,email,telepon,aktif,keterangan,crtdt,crtusr,modidt,modiusr) VALUES ('$kd_supplier',NOW(),'$nama','$alamat','$email','$telepon',1,'$keterangan',NOW(),'$nm_user',NOW(),'$nm_user')";
