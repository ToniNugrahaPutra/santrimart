...
if (isset($_POST['retur'])) {
	...
	$query = "INSERT INTO `tabel_retur`(`no_faktur_retur`, `kd_barang`, `tgl_retur`, `id_user`, `total_retur`, `ket`, `crtdt`, `crtusr`) VALUES ('$faktur', '$kd_barang', NOW(), '$id_user', '$jml', '$ket', NOW(),'$nama')";
