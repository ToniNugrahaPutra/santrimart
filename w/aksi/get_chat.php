                ...
                $output .= '<div class="chat ' . $chatps . '">
                                <div class="chat-avatar">
                                    <a class="avatar m-0" data-toggle="tooltip" href="#"
                                        ...
                                        <img src="' . $foto . '" onerror="this.src=\'../img/user/user.png\';" alt="avatar" height="40"
                                            width="40" />
                                    </a>
                                </div>
                                <div class="chat-body">
                                    <div class="chat-content">
                                        <img src="' . $target . '" height="120" width="120"  style="cursor:pointer;" data-target="#exampleModalCenter" onClick="openImg(\'' . $target . '\')" data-toggle="modal" onerror="this.src=\'../img/user/user.png\';" alt="avatar"/>
                                    </div>
                                </div>
                            </div>';
            } else {
