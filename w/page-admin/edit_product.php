      ...
      <div class="card-body">
        <div class="divider">
          <div class="divider-text">
            <h3 class="mb-3 display-4 text-uppercase">Edit Produk <?php echo $_GET['id_barang'] ?></h3>
          </div>
        </div>
        <div class="row">
            ...
            <form method="post" action="../aksi/add_product.php" enctype="multipart/form-datamultipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-12 mt-2 mb-1">
                  <div class="font-small-2">Edit Foto terbaik <span class="badge badge-dark">Max.3 (JPG/JPEG/PNG)</span>
                  </div>
                </div>
